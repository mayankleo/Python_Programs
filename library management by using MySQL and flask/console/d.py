...
def cifnot():
  ...
  mycursor.execute("CREATE TABLE IF NOT EXISTS "+table2+" (id SMALLINT UNSIGNED AUTO_INCREMENT PRIMARY KEY, name VARCHAR(20) NOT NULL, uid SMALLINT UNSIGNED NOT NULL, book_id SMALLINT NOT NULL,  issue DATE NOT NULL, submit DATE)")
  mydb.close()
  idata()